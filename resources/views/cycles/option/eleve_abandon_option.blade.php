  ...
  <div class="content-wrapper">
        <div class="content">
           ...
           <div class="text-center bg-slate mb-3 py-2">
            <h6 class="card-title mt-2"><i class="icon-user-cancel mr-2 icon-1x text-muted-400  p-0 mb-2  mr-2"></i> Elève  Abandon</h6>
          </div>
           @if(!$EleveAbandonParOption->isEmpty())
          <table class="table table-striped text-nowrap table-customers">
            ...
            <tbody>
              @foreach($EleveAbandonParOption as $eleve)
              <tr>
                <td>
                  <div class="media">
                    <div class="mr-3">
