           ...
           <div class="card-header header-elements-inline bg-light">
            <h6 class="card-title"><i class="icon-search4 font-size-base mr-2"></i>Séléctionner la classe</h6>
          </div>
              <form class="p-2" action="{{route('classe',$cicles)}}" method="get">
              @csrf
                 <div class="row">
                    <div class="{{$cicles == 'Humanite'?'col-lg-3':'col-lg-4'}}">
                    ...
                    @endif
                     ...
                     <div class="{{$cicles == 'Humanite'?'col-lg-3':'col-lg-4'}}">
                    <button  type="submit" class="btn bg-indigo btn-block">
